...
<div class="offer__packages" id="offer-packages">
            ...
            while ($query->have_posts()): $query->the_post();
                ...
                <div class="offer__package-item <?php echo ($isActive) ? 'active' : '' ?>"
                    ...
                    <div class="offer__package-item-wrapper">
                        <h3 class="text-center text-uppercase font-weight-bold mb-2 mb-lg-5"><?php echo get_the_title(); ?></h3>
                        <div>
    ...
    <div class="offer__packages-switcher d-none d-lg-block" id="offer-packages-switcher">
        <?php
        foreach ($postsTitle as $title): ?>
            <button type="button"
                    class="switcher-item"
                    data-url="#<?php echo link_from_title($title) ?>">
